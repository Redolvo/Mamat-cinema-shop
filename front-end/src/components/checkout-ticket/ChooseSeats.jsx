        ...
        <div className="px-3">
            ...
            <div className="mb-10">
                <div className="flex items-center gap-1 mb-3 text-sm px-8">
                    <div
                        id={79}
                        onClick={(e) => setSeatNumber(e.target.id)}
                        className={`${
                            seat_number === 79
                        } bg-blues-500 rounded py-3 flex-1 text-center text-white`}
                    >
                        79
                    </div>
                    <div
            ...
            <NavLink to="/your-ticket/1">
                <Button className="text-center w-full" disabled={true}>
                    Book 0 Ticket(s) Rp.0
                </Button>
            </NavLink>
        </div>
    );
